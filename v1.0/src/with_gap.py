...
with gzip.open('./gencode.v44.pc_transcripts.fa.gz', 'rb') as file_in:
    with open('./gencode.v44.pc_transcripts.fa.fa', 'wb') as file_out:
...
if __name__ == '__main__':
  ...
  df.to_csv(f'triplex_pseudoknot_no_pseudo_buldge{end_date}_all_with_gap_minsize_7_pcRNA.csv', index=False)
  print(df)
